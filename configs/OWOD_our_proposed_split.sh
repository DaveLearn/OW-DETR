...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps_full/OWDETR_t1/checkpoint0044.pth' \
    ${PY_ARGS}  2>&1 | tee -a ${EXP_DIR}/run_log.txt

EXP_DIR=exps_full/OWDETR_t2_ft
PY_ARGS=${@:1}
mkdir -p ${EXP_DIR}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps_full/OWDETR_t2/checkpoint0049.pth' \
    ${PY_ARGS}  2>&1 | tee -a ${EXP_DIR}/run_log.txt

EXP_DIR=exps_full/OWDETR_t3
PY_ARGS=${@:1}
mkdir -p ${EXP_DIR}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps_full/OWDETR_t2_ft/checkpoint0099.pth' \
    ${PY_ARGS}  2>&1 | tee -a ${EXP_DIR}/run_log.txt

EXP_DIR=exps_full/OWDETR_t3_ft
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps_full/OWDETR_t3/checkpoint0104.pth' \
    ${PY_ARGS}  2>&1 | tee -a ${EXP_DIR}/run_log.txt

EXP_DIR=exps_full/OWDETR_t4
PY_ARGS=${@:1}
mkdir -p ${EXP_DIR}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps_full/OWDETR_t3_ft/checkpoint0159.pth' \
    ${PY_ARGS}  2>&1 | tee -a ${EXP_DIR}/run_log.txt

EXP_DIR=exps_full/OWDETR_t4_ft
PY_ARGS=${@:1}
mkdir -p ${EXP_DIR}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps_full/OWDETR_t4/checkpoint0169.pth' \
    ${PY_ARGS}  2>&1 | tee -a ${EXP_DIR}/run_log.txt